...
async def create_service(
    ...
    tenant_id = get_effective_tenant(user, request)
    services_service.create_service(tenant_id, professional_id, name, duration_minutes, price)
...
async def update_service(
    ...
    services_service.sync_service_professionals(
        service_id, tenant_id, name, duration_minutes, price, professional_ids
    )
    return RedirectResponse(url="/services", status_code=302)
